...
const QuestionnaireSetting = ({ params }: { params: { Id: string } }) => {
    ...
    const questionnaireURL = `/question/group-questionnaire/${searchParams.get('group_id')}/questionnaire/${params.Id}`
